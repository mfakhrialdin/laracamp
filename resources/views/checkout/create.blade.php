                    ...
                    <div class="row">
                        <div class="col-lg-5 col-12">
                            <div class="item-bootcamp">
                                <img src="/images/item_bootcamp.png" alt="" class="cover">
                                <h1 class="package">
                                    {{$camp->title}}
                                </h1>
                                <p class="description">
                        ...
                        <div class="col-lg-6 col-12">
                            ...
                            @csrf
                                ...
                                <div class="mb-4">
                                    ...
                                    <input name="phone" type="number" class="form-control {{$errors->has('phone') ? 'is-invalid' : ''}}" value="{{old('phone' ?: Auth::user()->phone)}}" required/>
                                    @if($errors->has('phone'))
                                ...
                                <div class="mb-4">
                                    ...
                                    <input name="address" type="number" class="form-control {{$errors->has('address') ? 'is-invalid' : ''}}" value="{{old('address' ?: Auth::user()->address)}}" required/>
